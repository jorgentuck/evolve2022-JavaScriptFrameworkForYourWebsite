...
<xsl:stylesheet version="3.0"
	...
	<xsl:template name="template-footcode">
		<xsl:if test="/document/descendant::div[@id='interior-conditional-footcode']">
			<script src="/_resources/js/evolve/interior-conditional-footcode.js" type="text/javascript"></script>
		</xsl:if>
	</xsl:template>
